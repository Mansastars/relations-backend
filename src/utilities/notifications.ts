                  ...
                  ">
                              ...
                              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                  <tr>
                                      <td style="
                          padding-bottom: 20px;
                          border-bottom: 1px solid #4a4b4d5c;
                        ">
                                          <div style="
                            font-size: 26px;
                            font-style: normal;
                        ...
                        ">
                          ...
                          ">
                            ...
                            ">
                                                  MRR YTD<br />
                                                  <img class="chart image" src=${chartImageUrl} alt="Chart"
                    ...
                    ">
                                  <div>
                                      <p>
                                          ...
                                          <a href="https://relations.mansastars.com/" style="color: #01b7b7"
                                              target="_blank">here</a>.
                                      </p>
                                  </div>
  
                                  <p>
                                      <a href="https://relations.mansastars.com/" style="color: #01b7b7" target="_blank"
                                          rel="noopener noreferrer">www.mansastars.com</a>
                                  </p>
